...
module.exports = {
	...
	// API key
	apikey: '2F2BT6DA8fXEkoeS1L7e4fIQtXlvHU2e',
	...
	session: {
		...
		encryptionKey: '8/4GCTLf3KrEU6EfcNTA9SSJknm2Z3mEvLQWrtfpEq8=',
		signatureAlgorithm: 'sha512-drop256',
		signatureKey: 'qMl3EdJJkCFdavag2Uhe/n9l9wD4xvV1LloKIzTSmUIk0ReM7YWLggcui+2qgVbin3BY+dM9rGeE9+s5MUhhbA==',
		secret: 'oumLLMCztrJ1T4j0njS6ld/M2lqhzIa8', // should be a large unguessable string
	...
	cookieSecret: 'qU+eRUIhhxADO+YgI6fSnpWJWE43SBHj',
